...
/***
   ...
   ***/
//This method is used to get the list of products from DB
...
//Function used to filter the product category
...
//Function used to drag and drop the event with close icon
function drop(ev) {
    ev.preventDefault();
    $("#searchText").val('');
